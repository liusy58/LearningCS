...
my $COMPILER = "l2c";		# name of compiler to generate
my $COMPILER_EXEC = "bin/l2c";	# compiler executable
my $REF_COMPILER = "/usr0/autolab/autolab/courses/15411-f09/labs/lab2tests/bin/l2c";
				# reference compiler
my $LEXT = "l2";		# source filename extension
my $GCC = "gcc -m64";		# gcc executable and default flags
my $RT = "l2rt.c";		# runtime system for linking against asm file
...
my $TESTS1_MIN = 47;		# no score below 47 - fix later

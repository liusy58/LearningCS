...
However, several morden cluster computers have moved to more hybrid solutions where middleware is functionally patitioned across different nodes, becuase having compute nodes with dedicated, lightweight operating system will most likely provide optimal performace 

...
???+info "Architecture"
    A traditional architecture is shown below. This architecture consists of 4 layers. The fabric layer provides interfaces to local resources at a specific site. 
    ![](img/01-08.png)

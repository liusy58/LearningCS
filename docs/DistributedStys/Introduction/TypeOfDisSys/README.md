...
???+info "Architecture"
    A traditional architecture is shown below. This architecture consists of 4 layers. The fabric layer provides tailored interfaces to allow sharing resources 
    ![](img/01-08.png)

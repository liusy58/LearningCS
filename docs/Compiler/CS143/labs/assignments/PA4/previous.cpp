//
// Created by bigdataflow on 3/11/22.
//
...
void process_method(method_class*method );
...
void ClassTable::install_basic_classes() {
    ...
    class_name_2_class_definition[Object] = Object_class;
    class_name_2_class_definition[Str] = Str_class;
    class_name_2_class_definition[Bool] = Bool_class;
    class_name_2_class_definition[Int] = Int_class;
    class_name_2_class_definition[IO] = IO_class;
...
void type_check(Class_ class_definition){
    ...
    for(auto &[class_name,method_definition]:current_class_methods){
        process_method()
    }
...
void build_attribute_scopes(Class_ class_definition){
    ...
    auto name = class_definition->get_name();
    if(name == Object){
        return;
    }
    auto parent_name = class_name_2_parent_class_name[name];
    auto parent_class = class_name_2_class_definition[parent_name];
